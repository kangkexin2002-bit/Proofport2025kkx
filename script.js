document.addEventListener('DOMContentLoaded', function() {
    ...
    const textSteps = [
        { text: "Not every proof", bgColor: "#005AFF", textColor: "white" },     
        { text: "lives in papers", bgColor: "#FEFE00", textColor: "black" },     
        { text: "sometimes", bgColor: "#FF00FF", textColor: "white" },          
        { text: "it's in the quiet traces", bgColor: "#FF8E00", textColor: "black" },  
        { text: "only you can see", bgColor: "#00FF00", textColor: "black" },    
        { text: "Proofport", bgColor: "#00FF00", textColor: "black" }            
    ];
